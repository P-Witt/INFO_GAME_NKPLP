...
public class Vector2 {  // Mathematischer Vektor mit Standard komponentenweiser Multiplikation und Addition über den "Reellen" Zahlen
  ...
  public static Vector2 directionalvector (Vector2 v1, Vector2 v2){    // Gibt einen Vektor der Einheitsgröße in Richtung von v1 nach v2 zurück
